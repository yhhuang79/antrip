...
public class PublicTripListLoader extends AsyncTaskLoader<List<String>> {
	
	List<String> trips;
	
	public PublicTripListLoader(Context context) {
		super(context);
	}
	...
	public List<String> loadInBackground() {
		...
		try {
			...
			URL url = new URL("http://192.168.56.102/getTrips.php?userid=123&view=public");
			...
			if (code == 200) {
				...
				JSONArray array = queryresult.getJSONArray("public");
