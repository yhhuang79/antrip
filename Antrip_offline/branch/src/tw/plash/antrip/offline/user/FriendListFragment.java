...
public class FriendListFragment extends ListFragment implements LoaderCallbacks<List<String>> {
		...
		if(arg1 != null){
			...
			retry.findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					getLoaderManager().restartLoader(0, null, FriendListFragment.this);
